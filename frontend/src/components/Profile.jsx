                    ...
                    user?.role === 'applicant' && (
                        <>
                            ...
                            <div className='grid w-full max-w-sm items-center gap-1.5'>
                                ...
                                {
                                    user?.profile?.resume ? <a target='blank' href={user?.profile?.resume} className='text-blue-500 w-full hover:underline cursor-pointer'>{user?.profile?.resumeOriginalName || 'Download Resume'}</a> : <span>NA</span>
                                }
                            </div>
                        </>
                    )
